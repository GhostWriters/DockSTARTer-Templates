...
[![Compose Templates](https://img.shields.io/static/v1?style=flat-square&color=607D8B&label=compose&message=templates)](https://github.com/GhostWriters/DockSTARTer-Templates/tree/main/.apps/postgres)
...
Strongly consider also installing [pgAdmin](https://github.com/GhostWriters/DockSTARTer-Templates/tree/main/.apps/pgadmin) for administration and [pgBackup](https://github.com/GhostWriters/DockSTARTer-Templates/tree/main/.apps/pgbackup) for periodic rotating backups.
